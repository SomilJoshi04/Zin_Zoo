      ...
      <div className="flex-1 max-w-[480px] mx-auto w-full px-6 py-4 flex flex-col justify-center -mt-8 relative z-20">
        ...
        <div className="bg-white dark:bg-[#1a1a1a] rounded-[2rem] p-6 sm:p-8 md:p-12 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.15)] dark:shadow-none border border-gray-50 dark:border-gray-800">
           <div className="text-center mb-6 space-y-2">
              ...
              <div className="h-1 w-12 bg-[#F84E04] mx-auto rounded-full" />
           </div>
                ...
                <div className="space-y-4">
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-1 flex items-center pointer-events-none">
                      <Phone className="w-5 h-5 text-gray-400 group-focus-within:text-[#F84E04] transition-colors" />
                    </div>
                    ...
                    <input
                      ...
                      maxLength={10}
                      className="block w-full pl-20 pr-4 py-3 bg-transparent text-gray-900 dark:text-white border-b-2 border-gray-100 dark:border-gray-800 focus:border-[#F84E04] outline-none transition-all placeholder:text-gray-300 font-bold text-lg"
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                   <div className="flex items-center gap-3 bg-gray-50 dark:bg-gray-900 p-4 rounded-2xl border border-dashed border-gray-200 dark:border-gray-800">
                      <div className="w-10 h-10 bg-[#F84E04]/10 rounded-full flex items-center justify-center">
                         <ShieldCheck className="w-5 h-5 text-[#F84E04]" />
                      </div>
                  ...
                  <div className="text-center mt-4">
                    {resendTimer > 0 ? (
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="text-xs font-black text-[#F84E04] underline disabled:opacity-60 disabled:cursor-not-allowed"
                      >
                        Resend OTP
                      </button>
                    )}
            ...
            <button
              ...
              className={`w-full py-4 rounded-2xl font-black text-lg transition-all relative overflow-hidden shadow-xl ${
                loading
                  ...
                  : "bg-[#F84E04] hover:bg-[#D6005E] text-white hover:shadow-2xl hover:shadow-[#F84E04]/30 active:scale-[0.98] hover:-translate-y-0.5"
              }`}
            >
              {loading ? (
        ...
        <div className="mt-6 text-center space-y-2">
           <p className="text-[10px] text-gray-400 font-bold uppercase tracking-[0.2em] leading-relaxed">
             ...
             <Link to="/food/user/profile/terms" className="text-gray-900 dark:text-white underline cursor-pointer hover:text-[#F84E04] transition-colors">Terms of Service</Link> & <Link to="/food/user/profile/privacy" className="text-gray-900 dark:text-white underline cursor-pointer hover:text-[#F84E04] transition-colors">Privacy Policy</Link>
           </p>
        </div>
      </div>
    </div>
