              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="space-y-4 md:space-y-6 lg:space-y-8">
                  ...
                  {filteredTransactions.length > 0 ? (
                    ...
                    <div className="py-16 md:py-20 lg:py-24 flex flex-col items-center justify-center">
                      <div className="w-20 h-20 md:w-24 md:h-24 bg-gray-50 dark:bg-gray-800/50 rounded-full flex items-center justify-center mb-6 shadow-inner">
                        <IndianRupee className="w-10 h-10 md:w-12 md:h-12 text-gray-300 dark:text-gray-600" />
                      </div>
                      <h3 className="text-gray-800 dark:text-gray-200 text-lg md:text-xl font-bold mb-2">No Transactions Found</h3>
                      <p className="text-gray-500 dark:text-gray-400 text-sm md:text-base text-center max-w-sm">
                        Your transactions will appear here once you start making orders or refunds.
                      </p>
                    </div>
                  )}
                </div>
