                  ...
                  >
                    ...
                    <div className="p-3 flex flex-col flex-grow">
                      <div className="flex items-center gap-1 mb-1">
                        ...
                        {product.foodType && (
                          <div className={`w-3 h-3 border shrink-0 flex items-center justify-center p-[1px] ml-1 ${product.foodType?.trim().toLowerCase() === 'veg' ? 'border-green-600' : 'border-red-600'}`}>
                            <div className={`w-1.5 h-1.5 rounded-full ${product.foodType?.trim().toLowerCase() === 'veg' ? 'bg-green-600' : 'bg-red-600'}`} />
                          </div>
                        )}
                      </div>
